...
Source0  : https://files.pythonhosted.org/packages/33/e9/ac8a93e9eda3891ecdfecf5e01c060bbd2c44d4e3e77efc83b9c7ce9db32/markdown-it-py-2.1.0.tar.gz
...
%prep
%setup -q -n markdown-it-py-2.1.0
cd %{_builddir}/markdown-it-py-2.1.0
pushd ..
cp -a markdown-it-py-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656394550
...
cp %{_builddir}/markdown-it-py-2.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-markdown_it_py/ab5a711cce75e49bdbd08bbcb728262e30580e5d
cp %{_builddir}/markdown-it-py-2.1.0/LICENSE.markdown-it %{buildroot}/usr/share/package-licenses/pypi-markdown_it_py/5ff31979b5da51a43fc76f781675a8f86aed52f2
