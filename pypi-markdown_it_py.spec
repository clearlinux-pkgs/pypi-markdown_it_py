...
Source0  : https://files.pythonhosted.org/packages/e4/c0/59bd6d0571986f72899288a95d9d6178d0eebd70b6650f1bb3f0da90f8f7/markdown-it-py-2.2.0.tar.gz
...
%prep
%setup -q -n markdown-it-py-2.2.0
cd %{_builddir}/markdown-it-py-2.2.0
pushd ..
cp -a markdown-it-py-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677082912
