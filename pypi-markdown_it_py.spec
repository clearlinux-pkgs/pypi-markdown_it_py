...
%prep
%setup -q -n markdown-it-py-2.0.1
cd %{_builddir}/markdown-it-py-2.0.1
...
cp %{_builddir}/markdown-it-py-2.0.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-markdown_it_py/ab5a711cce75e49bdbd08bbcb728262e30580e5d
cp %{_builddir}/markdown-it-py-2.0.1/LICENSE.markdown-it %{buildroot}/usr/share/package-licenses/pypi-markdown_it_py/5ff31979b5da51a43fc76f781675a8f86aed52f2
